...
### [PledgePlatform](PledgePlatform.md)
...
1. **For Developers**
   ```bash
   git clone https://github.com/your-org/critical-money
   cd critical-money
   forge install
   forge test
   ```
...
3. **For Investors**
   - Review [Investment Guide](investment.md)
   - Prepare USDC for deposit
   - Monitor reward accumulation

## Additional Resources

- [GitHub Repository](https://github.com/your-org/critical-money)
